...
public class MissionGlassBreaks : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (ObjectiveManager.Instance.objectiveList[i].objectiveType == ObjectiveType.GlassBreaks)
            {
    ...
    void VerifyMission()
    {
        ...
        if (brokenGlassPanels >= glassPanelsToBreak)
        {
            isCompleted = true;
        }
